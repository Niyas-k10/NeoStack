...
function HeroContent() {
  ...
  return (
    <div className="relative z-10 flex flex-col items-start w-full max-w-full">
      ...
      {/* Hero Headline */}
      <div className="mt-6 sm:mt-10 md:mt-12 w-full font-display font-light text-black tracking-[-0.05em] uppercase">
        <h1 className="text-4xl xs:text-5xl sm:text-7xl md:text-8xl lg:text-[7.5rem] xl:text-[9rem] leading-[0.94] flex flex-col items-start gap-y-1 xs:gap-y-2 sm:gap-y-4">
          <span className="font-normal text-black shrink-0">We Build</span>

          {/* Morphing Keyword Container */}
          <span className="relative inline-block overflow-hidden py-0.5 sm:py-1 w-full max-w-full min-w-0 sm:min-w-[480px] md:min-w-[600px]">
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="inline-block italic font-serif font-light text-[#222222] truncate max-w-full"
              >
                {keywords[index]}
              </motion.span>
            </AnimatePresence>
      ...
      <motion.div
        ...
        className="mt-8 sm:mt-14 md:mt-16 flex flex-col sm:flex-row items-stretch sm:items-center justify-between w-full border-t border-[#ECECEC] pt-6 sm:pt-8 gap-4"
      >
